...
<body>
	...
	<div id="main" class="container">
		...
		<c:if test="${not empty chamados}">
			<p>Selecione os chamados que deseja fechar.</p>
									...
									<td>
										<div class="checkbox">
											<label> <input type="checkbox"
												name="${chamado.numero}"> ${chamado.numero}
											</label>
										</div>
									</td>
				...
				<div id="actions" class="row">
					<div class="col-md-12">
						<button type="submit" class="btn btn-primary" name="acao"
							value="FecharChamados">Fechar Chamados</button>
		...
		<c:if test="${empty chamados}">
			<div class="alert alert-info" role="alert">Não existe chamado nesta fila.</div>
