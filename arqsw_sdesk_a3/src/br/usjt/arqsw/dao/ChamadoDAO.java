...
public class ChamadoDAO {
	...
	public static class ListarChamados {
		public static void main(String[] args) {
			...
			chamados.setDataFechamento(null);
			chamados.setDescricao("ArqSw");
			chamados.setFila(fila);
			chamados.setNumero(1);
			chamados.setStatus("ABERTO");
			...
			ArrayList<Chamado> lista = chamados.selecionarTodas();
